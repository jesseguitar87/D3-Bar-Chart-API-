...
d3.select(".title")
   .html("<h2>" + FCC_DATA.name + "</h2>");

d3.select(".description")
   .html("<h6>" + FCC_DATA.description + "</h6>");

var margin = {top: 20, right: 60, bottom: 30, left: 60},
    width = 1120 - margin.left - margin.right,
    height = 500 - margin.top - margin.bottom;

var data = FCC_DATA.data

var x = d3.time.scale()
   .domain([d3.min(data, function(d) { return new Date(d[0]); }),
            d3.max(data, function(d) { return new Date(d[0]); })])
   .range([0, width]);
...
bar.append("rect")
   ...
   .on("mouseover", function(d, i) {
      var year = parseInt(d[0].slice(0, 4));
      var month = parseInt(d[0].slice(5, 7));
      var day = parseInt(d[0].slice(8));
      var dataDate = new Date(year, (month - 1), day, 12);
      var dateDisplay = dataDate.toLocaleString('en-US', {month: 'long', year: 'numeric'});
   
      d3.select(".tooltip")
         .style("opacity", 1)
         .style("left", (d3.event.pageX + 20) + "px")
         .style("top", (d3.event.pageY - 30) + "px")
         .html("<p>" + dateDisplay + "</p><h2>$" + d[1] + " Billion</h2>");
   })
